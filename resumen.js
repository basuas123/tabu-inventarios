...
export default function DireccionPage() {
  ...
  async function cargarDatos() {
    ...
    try {
      ...
      // Agregar sucursales que tienen análisis de Soft aunque no tengan inventario capturado
      SUCURSALES.forEach(s => {
        if (!map[s.k] && analisisMap[s.k]) {
          map[s.k] = calcularImpacto(s.k, {}, analisisMap[s.k]) || {}
        }
